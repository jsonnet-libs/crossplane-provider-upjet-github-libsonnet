{
  ...
  '#':: d.pkg(name='teamSyncGroupMapping', url='', help='"TeamSyncGroupMapping is the Schema for the TeamSyncGroupMappings API. Creates and manages the connections between a team and its IdP group(s)."'),
  ...
  '#new':: d.fn(help='new returns an instance of TeamSyncGroupMapping', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TeamSyncGroupMappingSpec defines the desired state of TeamSyncGroupMapping"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#group':: d.obj(help='"An Array of GitHub Identity Provider Groups (or empty []).  Each group block consists of the fields documented below.\\nAn Array of GitHub Identity Provider Groups (or empty [])."'),
      group: {
        '#withGroupDescription':: d.fn(help='"The description of the IdP group.\\nThe description of the IdP group."', args=[d.arg(name='groupDescription', type=d.T.string)]),
        withGroupDescription(groupDescription): { groupDescription: groupDescription },
        '#withGroupId':: d.fn(help='"The ID of the IdP group.\\nThe ID of the IdP group."', args=[d.arg(name='groupId', type=d.T.string)]),
        withGroupId(groupId): { groupId: groupId },
        '#withGroupName':: d.fn(help='"The name of the IdP group.\\nThe name of the IdP group."', args=[d.arg(name='groupName', type=d.T.string)]),
        withGroupName(groupName): { groupName: groupName },
      },
      '#withGroup':: d.fn(help='"An Array of GitHub Identity Provider Groups (or empty []).  Each group block consists of the fields documented below.\\nAn Array of GitHub Identity Provider Groups (or empty [])."', args=[d.arg(name='group', type=d.T.array)]),
      withGroup(group): { spec+: { forProvider+: { group: if std.isArray(v=group) then group else [group] } } },
      '#withGroupMixin':: d.fn(help='"An Array of GitHub Identity Provider Groups (or empty []).  Each group block consists of the fields documented below.\\nAn Array of GitHub Identity Provider Groups (or empty [])."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='group', type=d.T.array)]),
      withGroupMixin(group): { spec+: { forProvider+: { group+: if std.isArray(v=group) then group else [group] } } },
      '#withTeamSlug':: d.fn(help='"Slug of the team\\nSlug of the team."', args=[d.arg(name='teamSlug', type=d.T.string)]),
